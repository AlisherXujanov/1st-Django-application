...
class Book(models.Model):
    ...
    genre = models.CharField(max_length=50, blank=True, help_text="Genre of Book") 
    image = models.ImageField(default='book.jpg', upload_to='book_img')
    title = models.CharField(max_length=100)
    intro = models.CharField(max_length=300, blank=True, help_text='What is the Book about?')
